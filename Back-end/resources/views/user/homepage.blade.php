...
<main>
    ...
    <!-- Sản phẩm bán chạy -->
    <h1 class="sanpham-h1 container mb-5">Sản phẩm bán chạy</h1>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 mt-3">
                <div class="sp sh-mode card text-center">
                    ...
                    <img class="card-img-top" src="/img/slide2.avif" alt="Title">
                    <div class="card-body">
                        <h4 class="card-title">SH MODE 2023</h4>
                        <p class="card-text">
                            <s class="mx-2" style="color: rgb(109, 108, 107);">83.525.000₫</s>
                            75.172.500₫
                        </p>
            ...
            <div class="col-lg-3 col-sm-6 mt-3">
                <div class="sp vespa card text-center">
                    <div class="icon-heart">
                        <i class='bx bxs-heart'></i>
                    </div>
                    <img class="card-img-top" src="/img/slide3.jpg" alt="Title">
                    <div class="card-body">
                        <h4 class="card-title">VESPA TFT 2023</h4>
                        <p class="card-text">98.400.000₫</p>
                        <div class="btn-xemThem">
                            <a class="muaNgay" href="/sanpham/chitiet/vespa.html" role="button">Xem thêm</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 mt-3">
                <div class="sp sh-mode card text-center">
                    ...
                    <img class="card-img-top" src="/img/ab-2023.png" alt="Title">
                    <div class="card-body">
                        <h4 class="card-title">AIR BLADE 2023</h4>
                        <p class="card-text">42.790.000₫</p>
                        <div class="btn-xemThem">
                            <a class="muaNgay" href="/sanpham/chitiet/Air-blade.html" role="button">Xem thêm</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 mt-3">
                <div class="sp vario card text-center">
                    <div class="icon-heart">
                        <i class='bx bxs-heart'></i>
                    </div>
                    <img class="card-img-top" src="/img/vario.jpg" alt="Title">
                    <div class="card-body">
                        <h4 class="card-title">VARIO 160 2023</h4>
                        <p class="card-text"> 55.690.000₫</p>
                        <div class="btn-xemThem">
                            <a class="muaNgay" href="/sanpham/chitiet/Vario.html" role="button">Xem thêm</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="xe_1" class="xeSo container">
        <div class="row">
            <div class="col-lg-3 col-sm-6 sanpham_xeSo">
                ...
                <img class="card-img-top img-fluid" src="/img/blade-2023.png" alt="Title">
                <div class="card-body">
    ...
    <div id="xe_2" class="xeGa container" style="display: none;">
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 sanpham_xeGa">
                ...
                </div> <img class="card-img-top img-fluid" src="/img/New-Grande-Pearl-White-004.png"
                    alt="Title">
                <div class="card-body">
